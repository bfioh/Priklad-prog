...
from get_middle_size import get_middle_size
from get_day import get_day_of_week
...
# задача 2
@app.route('/get_middle_size', methods=['POST'])
def calculate_mean_size():
    data = request.data.decode('utf-8')
    middle_size = get_middle_size(data)
    return str(middle_size)
...
def hello(name):
    ...
    day_of_week_name = get_day_of_week(weekday)
