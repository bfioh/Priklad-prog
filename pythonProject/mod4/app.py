...
#Валидатор должен принимать на вход параметры min и max — минимальная и максимальная длина, а также опциональный параметр message
class NumberLength:
...
#Напишите GET-endpoint /uptime, который в ответ на запрос будет выводить строку вида f"Current uptime is {UPTIME}"
...
def ps():
    ...
    try:
        ...
        return f'Ошибка при выполнении команды: {e}', 500
